    ...
    if(str_receive[0] == '[' && str_receive[1] == 'p' && str_receive[2] == 'i' && str_receive[3] == 'd' && str_receive[4] == ':')
        {
                ...
                char* Kp_d = (char*)malloc(7);
                char* Ang_offset = (char*)malloc(7);
                
                int Ka_p_len=0, Ka_i_len=0, Ka_d_len=0, Kp_p_len=0, Kp_i_len=0, Kp_d_len=0, Ang_offset_len=0, Spd_len=0, Ang_len=0;
                int count_which=0;
